...
| `architecture-portal/` | [architecture-portal/AGENTS.md](architecture-portal/AGENTS.md) | Architecture Intelligence Platform — interactive docs browser, knowledge graph, Mermaid diagrams, React Flow graphs, AI assistant |
...
- Root-level tools and assets (CSV data, Instagram scripts, Stripe debug output, database reference docs)
