...
const AnalyticsPanel = () => {
    // Use the custom hook to get data directly from the parent context
    const { data } = useAdminData();

    // Add a check to handle the case where data might not be loaded yet
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            <header className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">An overview of platform-wide growth and engagement.</p>
            </header>
            <div className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800/50 rounded-xl shadow-md p-4 sm:p-6">
                    ...
                    <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                        {analyticsData.topCreators.map((creator: any) => (
