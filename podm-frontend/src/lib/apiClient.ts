 ...
 */
export const createSubscription = (creatorId: string, tierId: string, paymentMethodId: string) =>
    api('post', '/subscriptions', { creatorId, tierId, paymentMethodId });
...
export const createStripeOnboardingLink = () =>
    api('post', '/stripe/connect/onboarding-link');
...
export const unlockMessageContent = (messageId: string) =>
    api('post', '/payments/unlock-message', { messageId });
 ...
 */
export const updateFanPaymentMethod = (paymentMethodId: string) =>
    api('put', '/users/me/payment-method', { paymentMethodId });
...
export const createSetupIntent = () =>
    api('post', '/users/me/setup-payment-method');
 ...
 */
export const unlockPost = (contentId: string, paymentMethodId?: string) =>
    api('post', '/payments/unlock-post', { contentId, paymentMethodId });
