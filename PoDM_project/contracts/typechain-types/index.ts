...
export type { PoDMPaymentProtocol } from "./contracts/PoDMPaymentProtocol";
export { PoDMPaymentProtocol__factory } from "./factories/contracts/PoDMPaymentProtocol__factory";
